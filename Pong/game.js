 ...
 ***********************************************************************/
function __sprite_4() { 
__sprite_init__(this, sprite_4, 20, 100, 10, 50, 'Box', 10, 0, 20, 0, 100, ['img/sprite_4_0.png']);
}; var sprite_4 = new __sprite_4();

function __sprite_13() { 
__sprite_init__(this, sprite_13, 20, 20, 10, 10, 'Box', 10, 0, 20, 0, 20, ['img/sprite_13_0.png']);
 ...
 ***********************************************************************/
function __font_20() { 
__font_init__(this, font_20, 'Arial', 24, 1, 0)}; var font_20 = new __font_20();
 ...
 ***********************************************************************/
function __obj_pf1() {
__instance_init__(this, obj_pf1, null, 1, 0, sprite_4, 1, 0);
...
}; var obj_pf1 = new __obj_pf1();

function __obj_pf2() {
__instance_init__(this, obj_pf2, null, 1, 0, sprite_4, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_pf2 = new __obj_pf2();

function __obj_ball() {
__instance_init__(this, obj_ball, null, 1, 0, sprite_13, 1, 4);
...
if (unactive==0)
{
if (place_meeting(x-10,y,obj_pf1))
{
	if (global.ypos1>y)
	{
		ydpose=global.ypos1-y;
	}
	if (global.ypos1<y)
	{
		ydpose=global.ypos1-y;
	}
	global.ydposee=ydpose;
	direction=(180-direction+ydpose);
	
	unactive=1;
	speed+=0.3;
}
if (place_meeting(x+10,y,obj_pf2))
{
	if (global.ypos2>y)
	{
		ydpose=global.ypos2-y;
	}
	if (global.ypos2<y)
	{
		ydpose=global.ypos2-y;
...
function __object_17() {
__instance_init__(this, object_17, null, 1, 0, null, 1, 6);
this.on_creation = function() {
with(this) {
...
__handle_sprite__(this);
with(this) {
draw_text(0,0,global.dir);
draw_text(0,40,global.wait);
draw_text(0,80,global.unact);
draw_text(0,120,global.ypos1);
draw_text(0,160,global.ypos2);
draw_text(0,200,global.ydposee);
draw_text(280,20,global.score2);
draw_text(300,20,":");
draw_text(315,20,global.score1);
}
}
};
}; var object_17 = new __object_17();

function __object_24() {
__instance_init__(this, object_24, null, 1, 0, null, 1, 8);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
this.objects = [
[{o:obj_pf1, x:20, y:180}],
[{o:obj_pf2, x:600, y:180}],
[{o:obj_ball, x:320, y:220}],
[{o:object_17, x:0, y:0}],
[{o:object_24, x:320, y:220}]];
this.start = function() {
__room_start__(this, scene_2, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
